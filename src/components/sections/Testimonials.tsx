  ...
  return (
    <section id="testimonials" className="py-12 relative z-20 overflow-hidden">
      ...
      <div className={`max-w-4xl mx-auto px-6 text-center mb-16 transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'}`}>
        ...
        <h3 className="text-3xl md:text-5xl font-bold tracking-tight text-white/50 mb-4 transition-all duration-1000 delay-300">
          You grow.
        </h3>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="mb-12 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-mono font-bold mb-4 text-white">
            Success Stories<br />
            <span className="text-white/60 font-sans">from the Creative Frontline</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {reviews.map((review) => (
            <div
              key={review.id}
              className="glass-panel p-8 rounded-2xl flex flex-col justify-between hover:scale-105 hover:bg-white/10 transition-all duration-300 shadow-xl shadow-black/20"
            >
              <div className="flex text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-sky-600 mb-6">
                {[1, 2, 3, 4, 5].map(star => (
              ...
              <p className="text-white/80 text-lg leading-relaxed mb-8">"{review.text}"</p>

              <div className="flex items-center">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-white/10 to-white/5 flex items-center justify-center text-xl font-bold text-sky-400 mr-4">
